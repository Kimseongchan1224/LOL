...
리그 오브 레전드는 세계 최고의 MOBA(Multiplayer-Online-Battle-Arena) 게임입니다. 끝없이 이어지는 실시간 전투와 협동을 통한 팀플레이,
RTS(Real-Time-Strategy)와 RPG(Role-Playing-Game)를 하나의 게임에서 동시에 즐길 수 있는 새로운 장르의 온라인 게임입니다.
